...
import com.docker.mysql.service.monitoring.MonitorService;
import com.docker.mysql.web.dto.SimpleResponseDTO;
...
public class HeartbeatWS {
    ...
    public SimpleResponseDTO isAlive() {
        ...
        return new SimpleResponseDTO(200, "DB-MySQL is alive!");
    }
    ...
    public SimpleResponseDTO isOnline() {
        ...
        if (monitorService.isDatabaseOnline()) {
            return new SimpleResponseDTO(200, "DB-MySQL is online!");
        }
